...
def process_document(input_file_path, output_file_path, preprocess, translate, check, postprocess, deepl_translate=False, 
...
if __name__ == "__main__":
    ...
    if not any([args.preprocess, args.translate, args.check, args.postprocess, args.deepl]) and not args.deepl_list_glossaries and not args.deepl_cleanup:
